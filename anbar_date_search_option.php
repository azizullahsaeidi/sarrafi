...
<script type="text/javascript" src="../cal/scripts/jquery.ui.datepicker-cc.js"></script>
  ...
  <script type="text/javascript">
	...
	<!-- Begining of Content -->
		<div class="content">
		<div class='span11' style="width:884px;margin:0px;min-height:24px;padding:5px 20px;"></div>
			...
			<div class="span11 add_table" style="width:500px;margin:0px;min-height:24px;padding:30px 20px;margin-right:170px;">
				...
				<form action="../controller/anbar_query.php" method="post" id="bank_date_search_option">
					...
					<tr>
						...
						<td class='input_align'>
							<select id="bank_acount_number" class="search_anbar" name="anbar_date_search_type">
