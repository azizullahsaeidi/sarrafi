				...
				<form action="../controller/box_query.php" method="post" id="bank_and_box">
					...
					<tr>
						...
						<td class='input_align' style="direction:ltr">
							...
							<input type="hidden" id="x-small-code" min="0" max='99' name="box_search_cur_id"  style="text-align:center" value="<?php echo get_currency_id('cur_id'); ?>" readonly required>
						</td>
					</tr>
					...
					<select id="bank_acount_number" class="search_anbar" name="box_search_year">
					...
					<select id="bank_acount_number" class="search_anbar" name="box_search_type">
						<option value="none"> انتخاب رسید / برگ پرداخت </option>
						<option value='arrive'>برگ رسید وجه</option>
						<option value='extract'>برگه پرداخت</option>
					...
					<tr>
						...
						<td class='input_align' style="">
							
							<input type="number" id="" min="1" max='999' name="box_search_serial_no_from"  style="text-align:center;width:107px;" required>
							<span style="margin: 0px 5px;">الی:</span><input type="number" id="" min="1" max='999' name="box_search_serial_no_to"  style="text-align:center;width:107px;" required>
						</td>
					</tr>
