...
$serial_query=mysql_query("select count(r_box_id) r_box_id from box_reason where r_box_id=$box_id and year='$year' and type='bank' order by r_box_id desc limit 1",$con);
...
?>
	<!-- Begining of Content -->
		...
		<?php alert_messages(); ?>
		<a href="bank_final_check_paper.php?s_n=<?php echo $box_id; ?>&cur=<?php echo $_GET['cur']; ?>">
