	...
	<!-- Begining of Content -->
		...
		<div class='span11' style="width:884px;margin:0px;min-height:24px;padding:5px 20px;"></div>
			...
			<div class="span11 add_table" style="width:500px;margin:0px;min-height:24px;padding:30px 20px;margin-right:170px;">
				...
				<form action="../controller/box_query.php" method="post" id="bank_date_search_option">
					...
					<tr>
						<td class='label_align'>  رسید / برگ پرداخت :</td>
						<td class='input_align'>
							<select id="bank_acount_number" class="search_anbar" name="box_date_search_type">
								<option value="none">انتخاب رسید / برگ پرداخت</option>
								<option value='arrive'>برگ رسید وجه</option>
								<option value='extract'>برگ پرداخت</option>
							</select>
						</td>
					</tr>
					<tr>
