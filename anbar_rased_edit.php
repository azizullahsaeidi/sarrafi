...
?>
	<!-- Begining of Content -->
		<div class="content">
		<?php
		if (isset($_GET['details_edit_id'])) {
			$details_id=$_GET['details_edit_id'];
			$type=$_GET['type'];
			if (isset($_GET['s_n_f'])) {
				$de_status='perm';
			}else{
		...
		<?php }?>
			...
			<div class="span11 messages">
				...
				<form action="../controller/anbar_query.php" method="post" id="hawala_rased_anbar">
					...
					<tr>
						<td class='label_align'>سریال نمبر:</td>
						<td class='input_align' style="direction:ltr">
							<input type="text"  min="01" max='99' name="serial_no_edit" readonly style="text-align:center" value="<?php echo $de_serial_no; ?>" required>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class='input_align'>
							<input type="number" id="product_number_edit" min="1" value="<?php echo $de_quantity; ?>" name="product_number_edit"  required >
